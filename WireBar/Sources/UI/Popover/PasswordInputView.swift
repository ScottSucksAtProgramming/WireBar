...
struct PasswordInputView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text(isEnterprise
                ? String(localized: "WireBar saves this account in your Mac's login keychain so it won't ask again. It stays on this Mac.")
                : String(localized: "WireBar saves this in your Mac's login keychain so it won't ask again. It stays on this Mac."))
                .font(.caption2)
                .foregroundStyle(.secondary)
